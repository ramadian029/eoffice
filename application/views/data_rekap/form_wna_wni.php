...
<script type="text/javascript">
    $(function() {
        ...
        $("#form_input").on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo site_url('data_rekap/save_wna_wni/') ?>" + id,
                data: parameter,
                ...
                <div class="box box-danger">
                    <div class="box-body">
                        ...
                        <div class="row" style="padding-top:10px">
                            ...
                            <div class="col-sm-2">
                                <input name="wni" type="text" class="form-control number" required
                                       value="<?= ((isset($data_rekap)) ? $data_rekap->wni : "0") ?>">
                            </div>
                        </div>
                        <div class="row" style="padding-top:10px">
                            <label class="col-sm-2 control-label">WNA</label>
                            <div class="col-sm-2">
                                <input name="wna" type="text" class="form-control number" required
                                       value="<?= ((isset($data_rekap)) ? $data_rekap->wna : "0") ?>">
                            </div>
                        </div>
                        <!--                        <div class="row" style="padding-top:10px">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <textarea name="keterangan" class="form-control" rows="3" 
                                                                  required><?= ((isset($data_rekap)) ? $data_rekap->keterangan : "") ?></textarea>
                                                    </div>
                                                </div>-->
                        <div class="container">				
                        </div><!-- /.box-body -->
