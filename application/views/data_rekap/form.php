            ...
            <div class="col-lg-12 col-md-12 col-xs-12 pd-0">
                <div class="box box-danger">
                    <div class="box-body">
                        ...
                        <hr>
                        <div class="row" style="padding-top:10px">
                            <label class="col-sm-2 control-label">WNI</label>
                        </div>
                        <div class="row" style="padding-top:10px">
                            <label class="col-sm-2 control-label" style="text-align: right">Laki-laki</label>
                            <div class="col-sm-2">
                                <input name="wni_l" type="text" class="form-control number" required
                                       value="<?= ((isset($data_rekap)) ? $data_rekap->wni_l : "0") ?>">
                            </div>
                            <!--                        </div>
                                                    <div class="row" style="padding-top:10px">-->
                            <label class="col-sm-2 control-label" style="text-align: right">Perempuan</label>
                            <div class="col-sm-2">
                                <input name="wni_p" type="text" class="form-control number" required
                                       value="<?= ((isset($data_rekap)) ? $data_rekap->wni_p : "0") ?>">
                            </div>
                        </div>
                        <hr>
                        <div class="row" style="padding-top:10px">
                            <label class="col-sm-2 control-label">WNA</label>
                        </div>
                        <div class="row" style="padding-top:10px">
                            <label class="col-sm-2 control-label" style="text-align: right">Laki-laki</label>
                            <div class="col-sm-2">
                                <input name="wna_l" type="text" class="form-control number" required
                                       value="<?= ((isset($data_rekap)) ? $data_rekap->wna_l : "0") ?>">
                            </div>
                            <!--                        </div>
                                                    <div class="row" style="padding-top:10px">-->
                            <label class="col-sm-2 control-label" style="text-align: right">Perempuan</label>
                            <div class="col-sm-2">
                                <input name="wna_p" type="text" class="form-control number" required
                                       value="<?= ((isset($data_rekap)) ? $data_rekap->wna_p : "0") ?>">
                            </div>
                        </div>
                        <hr>
                        <div class="row" style="padding-top:10px">
                            ...
                            <div class="col-sm-6">
                                <textarea name="keterangan" class="form-control" rows="3"><?= ((isset($data_rekap)) ? $data_rekap->keterangan : "") ?></textarea>
                            </div>
                        </div>
                        <div class="container">				
                        </div><!-- /.box-body -->
