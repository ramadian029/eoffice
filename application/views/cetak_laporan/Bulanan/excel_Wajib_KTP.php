...
REKAPITULASI JUMLAH PENDUDUK WAJIB KTP
...
<table width="100%">
    <thead>
        <tr>
            ...
            <th align="center" colspan="6">JUMLAH PENDUDUK YANG WAJIB KTP</th>
            <th align="center" rowspan="2" colspan="3">JUMLAH PENDUDUK WAJIB KTP</th>
...
//        if ($jumlah > 0) {
        ...
        foreach ($kelurahan AS $kel) {
            ...
            <tr>
                ...
                <?php
                $periode = $bln . '/' . $tahun;
                $data = $this->db->select(" a.* FROM data_wajib_ktp a
                                    INNER JOIN(
                                    SELECT MAX(id_wajib_ktp) AS id
                                    FROM data_wajib_ktp
                                    WHERE bulan = '$periode'
                                    GROUP BY id_kelurahan
                                    ) b
                                    ON a.id_wajib_ktp = b.id")
