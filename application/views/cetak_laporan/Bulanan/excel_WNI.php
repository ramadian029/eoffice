...
REKAPITULASI PENDUDUK WARGA NEGARA INDONESIA
...
//        if ($jumlah > 0) {
        ...
        foreach ($kelurahan AS $kel) {
            ...
            <tr>
                ...
                $data2 = $this->db->select(' a.* FROM data_penduduk a
                                    INNER JOIN(
                ...
                $pakhir_l = isset($data2) ? $data2->wni_l : '0';
                $pakhir_p = isset($data2) ? $data2->wni_p : '0';
                $pakhir_j = isset($data2) ? $pakhir_l + $pakhir_p : '0';
                ...
                $pawal_l = $pakhir_l + ($lahir_l + $datang_l) - ($mati_l + $luar_l);
                $pawal_p = $pakhir_p + ($lahir_p + $datang_p) - ($mati_p + $luar_p);
