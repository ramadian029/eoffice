...
//        ttl_iuran_karyawan = (parseFloat((nominal_gapok) * 2 / 100) + parseFloat((nominal_gapok) * 1 / 100)).format(2, 3, '.')
        ...
        var sisa_awal = parseFloat('<?= $sisa ?>');
        var realisasi_awal = parseFloat('<?= isset($realisasi) ? $realisasi->nominal_realisasi : 0 ?>');
        var jumlah = 0;
...
//        var sisa = nominal - jumlah;
        var sisa = (sisa_awal + realisasi_awal) - jumlah;
                ...
                <div class="box box-danger">
                    <div class="box-body">
                        ...
                        <div class="row" style="padding-top:10px">
                            ...
                            <div class="col-sm-3">
                                <input id="realisasi" name="realisasi" type="text" required class="numberbox form-control text-right nom" onkeyup="formatangka(this);" 
                                       value="<?php
                                       if (strpos(isset($realisasi) ? $realisasi->nominal_realisasi : 0, '.') != false) {
                                           echo isset($realisasi) ? number_format($realisasi->nominal_realisasi, 2, ",", ".") : 0;
                                       } else {
                                           echo isset($realisasi) ? number_format($realisasi->nominal_realisasi, 0, ",", ".") : 0;
                                       }
                                       ?>"
                                       onchange='sub_total();'>                                
                            </div>
                        ...
                        <div class="row" style="padding-top:10px">
                            ...
                            <div class="col-sm-3">
                                <input id="ppn" name="ppn" type="text" required class="numberbox form-control text-right nomxx" onkeyup="formatangka(this);" 
                                       value="<?php
                                       if (strpos(isset($realisasi) ? $realisasi->nominal_ppn : 0, '.') != false) {
                                           echo isset($realisasi) ? number_format($realisasi->nominal_ppn, 2, ",", ".") : 0;
                                       } else {
                                           echo isset($realisasi) ? number_format($realisasi->nominal_ppn, 0, ",", ".") : 0;
                                       }
                                       ?>"
                                       onchange='sub_total();'>
                            </div>
                        ...
                        <div class="row" style="padding-top:10px">
                            ...
                            <div class="col-sm-3">
                                <input id="pph4" name="pph4" type="text" required class="numberbox form-control text-right nomxx" onkeyup="formatangka(this);" 
                                       value="<?php
                                       if (strpos(isset($realisasi) ? $realisasi->nominal_pph4 : 0, '.') != false) {
                                           echo isset($realisasi) ? number_format($realisasi->nominal_pph4, 2, ",", ".") : 0;
                                       } else {
                                           echo isset($realisasi) ? number_format($realisasi->nominal_pph4, 0, ",", ".") : 0;
                                       }
                                       ?>"
                                       onchange='sub_total();'>
                            </div>
                        ...
                        <div class="row" style="padding-top:10px">
                            ...
                            <div class="col-sm-3">
                                <input id="pph21" name="pph21" type="text" required class="numberbox form-control text-right nomxx" onkeyup="formatangka(this);" 
                                       value="<?php
                                       if (strpos(isset($realisasi) ? $realisasi->nominal_pph21 : 0, '.') != false) {
                                           echo isset($realisasi) ? number_format($realisasi->nominal_pph21, 2, ",", ".") : 0;
                                       } else {
                                           echo isset($realisasi) ? number_format($realisasi->nominal_pph21, 0, ",", ".") : 0;
                                       }
                                       ?>"
                                       onchange='sub_total();'>
                            </div>
                        ...
                        <div class="row" style="padding-top:10px">
                            ...
                            <div class="col-sm-3">
                                <input id="pph22" name="pph22" type="text" required class="numberbox form-control text-right nomxx" onkeyup="formatangka(this);" 
                                       value="<?php
                                       if (strpos(isset($realisasi) ? $realisasi->nominal_pph22 : 0, '.') != false) {
                                           echo isset($realisasi) ? number_format($realisasi->nominal_pph22, 2, ",", ".") : 0;
                                       } else {
                                           echo isset($realisasi) ? number_format($realisasi->nominal_pph22, 0, ",", ".") : 0;
                                       }
                                       ?>"
                                       onchange='sub_total();'>
                            </div>
                        ...
                        <div class="row" style="padding-top:10px">
                            ...
                            <div class="col-sm-3">
                                <input id="pph23" name="pph23" type="text" required class="numberbox form-control text-right nomxx" onkeyup="formatangka(this);" 
                                       value="<?php
                                       if (strpos(isset($realisasi) ? $realisasi->nominal_pph23 : 0, '.') != false) {
                                           echo isset($realisasi) ? number_format($realisasi->nominal_pph23, 2, ",", ".") : 0;
                                       } else {
                                           echo isset($realisasi) ? number_format($realisasi->nominal_pph23, 0, ",", ".") : 0;
                                       }
                                       ?>"
                                       onchange='sub_total();'>
                            </div>
                        ...
                        <!--                        <div class="row" style="padding-top:10px">
                                                    ...
                                                    <div class="col-sm-3">-->
                        <input id="total" type="hidden" required class="form-control text-right" readonly=""
