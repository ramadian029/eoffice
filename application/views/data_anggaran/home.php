...
//            ],
            ...
            "ajax": {
                "url": "<?php echo site_url('data_anggaran/ajax_list') ?>",
                "type": "POST",
                "data": function (data) {
...
<section class="content">
    <div class="row">
        <div class="merah">DATA ANGGARAN</div>
            ...
            <div class="box box-danger">
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-lg-4" style="text-align: right; padding-top: 25px !important;">
                            <a href="<?= site_url('data_anggaran/form') ?>">
                                <button class="btn_input btn btn-success tmbh"><i class="fa fa-plus-square"></i> TAMBAH DATA</button>
                            </a>
                        </div>
                    </div>
                    </br>
