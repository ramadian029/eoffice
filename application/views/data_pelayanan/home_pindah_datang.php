...
<script type="text/javascript">
    $(document).ready(function() {
        // $('#tampil_data').load("<?php echo site_url('data_pelayanan/list_data_pindah_datang/') ?>");
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('data_pelayanan/ajax_list_pindah_datang') ?>",
                "type": "POST",
                "data": function(data) {
                    data.nik = $('#nik').val();
                    data.nama = $('#nama').val();
...
<!--                    <a href="<?= site_url('unggah-data-excel-kondisi-infrastruktur/' . $aktif) ?>">
                    ...
                    <div class="col-lg-7" style="text-align: right">
                        <a href="<?= site_url('tambah-data-pelayanan/pindah_datang') ?>">
                            <button class="btn_input btn btn-primary"><i class="fa fa-plus-square"></i> TAMBAH DATA</button>
                        </a>
                        <a href="<?= base_url("csv/TEMPLATE_DATANG.xlsx") ?>">
