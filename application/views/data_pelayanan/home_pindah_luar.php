...
<script type="text/javascript">
    $(document).ready(function() {
        // $('#tampil_data').load("<?php echo site_url('data_pelayanan/list_data_pindah_luar/') ?>");
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('data_pelayanan/ajax_list_pindah_luar') ?>",
                "type": "POST",
                "data": function(data) {
                    data.nik = $('#nik').val();
                    data.nama = $('#nama').val();
   ...
   <a href="<?= $url_download ?>">
       <button class="btn_input btn btn-success"><i class="fa fa-download"></i> UNDUH DATA EXCEL</button>
                                ...
                                <div class="panel-body">
                                    <div id='x'class="form-horizontal"> 
                                        ...
                                        <div class="form-group">
                                            <label for="country" class="col-sm-12">NIK</label>
                                            <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <label for="country" class="col-sm-12">Jenis Pindah</label>
                                            <div class="col-lg-12">
                                                <?php
                                                $opt_jenis[''] = 'Semua';
                                                ...
                                                echo form_dropdown('jenis_pindah', $opt_jenis, '', 'id="jenis_pindah" class="select2_single form-control"');
                                                ?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-5">
                                                <input type="text" name="waktu_a" value="" autocomplete="off" class="date form-control" id="waktu_a" placeholder="Dari Tanggal">
                                            </div>
                                            <div class="col-lg-1" style="padding-top: 10px"><center>s.d.</center></div>
                                            <div class="col-lg-5">
                                                <input type="text" name="waktu_b" value="" autocomplete="off" class="date form-control" id="waktu_b" placeholder="Sampai Tanggal">
                                            </div>
                                        </div>
                                        <div class="form-group">
                    ...
                    <div class="col-lg-7" style="text-align: right">
                        <a href="<?= site_url('tambah-data-pelayanan/pindah_luar') ?>">
                            <button class="btn_input btn btn-primary"><i class="fa fa-plus-square"></i> TAMBAH DATA</button>
                        </a>
                        <a href="<?= base_url("csv/TEMPLATE_PINDAH.xlsx") ?>">
                        <button class="btn_input btn btn-success"><i class="fa fa-download"></i> UNDUH TEMPLATE EXCEL</button>
                    </a>
                         <a href="<?= site_url('data_pelayanan/upload/' . $aktif) ?>">
                            <button class="btn_input btn btn-warning"><i class="fa fa-upload"></i> UNGGAH DATA EXCEL</button>
                        </a>
                    </div>
                    </br>
                        ...
                        <div id="tampil_data" class="">
                            <table id="table" class="table table-bordered table-striped table-hover" style="white-space: nowrap;">
                                <thead style="background-color: #ffffff; color:#666;">
                                    <tr>
                                        <!--Nama, Jenis Kelamin, Alamat Asal, Alamat Tujuan, Jenis PD, Keterangan-->
                                        <th>NO</th>
                                        <th>NAMA</th>
                                        <th>JENIS KELAMIN</th>
                                        <th>WNI/WNA</th>
