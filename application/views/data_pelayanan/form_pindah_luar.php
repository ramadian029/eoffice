...
<script type="text/javascript">
    $(function() {
        ...
        $("#form_input").on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo site_url('data_pelayanan/save_pindah_luar/') ?>" + id,
                data: parameter,
        ...
        $(document).on('click', '.btn_hapus', function() {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo site_url('data_pelayanan/delete') . '/' ?>" + $(this).attr('id') + '/id_luar/data_pindah_luar',
                success: function(result) {
...
<?php if (isset($data_layanan)) { ?>
            ...
            if (str == 'Antar Kelurahan') {
                ...
                $(".xx").attr("required", '');
//                $("#xxkelurahan_tujuan").attr("required", '');
//                $("#xkelurahan").attr("required", '');
                $("#xkecamatan").removeAttr("required");
                $("#xkota").removeAttr("required");
                $("#xprovinsi").removeAttr("required");
            ...
            if (str == 'Antar Kecamatan') {
                ...
                $(".xx").attr("required", '');
//                $("#xxkelurahan_tujuan").removeAttr("required");
//                $("#xkelurahan").attr("required", '');
                $("#xkecamatan").attr("required", '');
                $("#xkota").removeAttr("required");
                $("#xprovinsi").removeAttr("required");
...
<!--                                <input name="alamat_asal" type="text" class="form-control" placeholder="Jl. xxx" 
                        ...
                        <div class="row" style="padding-top:10px">
                            ...
                            <div class="col-sm-1">
                                <input name="rt_asal" type="text" class="number form-control" placeholder="000" maxlength="3" required
                            ...
                            <div class="col-sm-1">
                                <input name="rw_asal" type="text" class="number form-control" placeholder="000" maxlength="3" required
                                       value="<?= ((isset($data_layanan)) ? $data_layanan->rw_asal : "") ?>">
                            </div>
                        </div>
                        <div class="row"  style="padding-top:10px">
                            <label for="" class="col-sm-2 control-label"><span style="color: red">* </span> Kelurahan Asal</label>
                            <div class="col-sm-6">
                        ...
                        <div class="row"  style="padding-top:10px">
                            <label for="" class="col-sm-2 control-label"><span style="color: red">* </span> Kecamatan Asal</label>
                            <div class="col-sm-6">
...
<!--                                <input name="alamat_tujuan" type="text" class="form-control" placeholder="Jl. xxx" 
                        ...
                        <div class="row x" style="padding-top:10px">
                            ...
                            <div class="col-sm-1 x">
                                <input name="rt_tujuan" type="text" class="number form-control xx" placeholder="000" maxlength="3" required
                            ...
                            <div class="col-sm-1 x">
                                <input name="rw_tujuan" type="text" class="number form-control xx" placeholder="000" maxlength="3" required
                                       value="<?= ((isset($data_layanan)) ? $data_layanan->rw_tujuan : "") ?>">
                            </div>
                        </div>
                        <div class="row" id="xkelurahan" style="padding-top:10px">
                            <label class="col-sm-2 control-label"><span style="color: red">* </span> Kelurahan Tujuan</label>
                            <div class="col-sm-6">
                                <input name="kelurahan_tujuan" type="text" class="form-control" id="xkelurahan_tujuan"
                                       value="<?= ((isset($data_layanan)) ? $data_layanan->kelurahan_tujuan : "") ?>">
                            </div>
                        </div>
                        <div class="row" id="xxkelurahan" style="padding-top:10px">
                            <label class="col-sm-2 control-label"><span style="color: red">* </span> Kelurahan Tujuan</label>
                            <div class="col-sm-6">
                                <select name="kelurahan_tujuanx" id="xxkelurahan_tujuan" class="select2_single form-control text-uppercase">
                                    <option value="">PILIH</option>
                                    <?php
                                    $kode = $_SESSION['kode_kelurahan'];
                                    ...
                                    foreach ($list_kelurahan as $rows_kelurahan) {
                                        if ($_SESSION['level'] == 2) {
                                            ...
                                            $id_kelurahan = ((isset($data_layanan)) ? $data_layanan->kelurahan_tujuan : "");
                                            if ($rows_kelurahan->id_kel == $id_kelurahan)
                                                $selected = "selected";
                                            else
                                                $selected = "";
                        ...
                        <div class="row" id="xkecamatan" style="padding-top:10px">
                            <label class="col-sm-2 control-label"><span style="color: red">* </span> Kecamatan Tujuan</label>
                            <div class="col-sm-6">
                                <input name="kecamatan_tujuan" type="text" class="form-control"
                                       value="<?= ((isset($data_layanan)) ? $data_layanan->kecamatan_tujuan : "") ?>">
                            </div>
                        </div>
                        <div class="row" id="xkota" style="padding-top:10px">
                            <label class="col-sm-2 control-label"><span style="color: red">* </span> Kab/Kota Tujuan</label>
                            <div class="col-sm-6">
                                <input name="kota_tujuan" type="text" class="form-control"
                                       value="<?= ((isset($data_layanan)) ? $data_layanan->kota_tujuan : "") ?>">
                            </div>
                        </div>
                        <div class="row" id="xprovinsi" style="padding-top:10px">
                            <label class="col-sm-2 control-label"><span style="color: red">* </span> Provinsi Tujuan</label>
                            <div class="col-sm-6">
                                <input name="provinsi_tujuan" type="text" class="form-control"
                                       value="<?= ((isset($data_layanan)) ? $data_layanan->provinsi_tujuan : "") ?>">
                            </div>
                        </div>
                        <div class="row" id="xnegara" style="padding-top:10px">
                            <label class="col-sm-2 control-label"><span style="color: red">* </span> Negara Tujuan</label>
                            <div class="col-sm-6">
                                <input name="negara_tujuan" type="text" class="form-control"
                                       value="<?= ((isset($data_layanan)) ? $data_layanan->negara_tujuan : "") ?>">
                            </div>
                        </div>
                        ...
                        <div class="box-footer">
                            <div class="row">
                                ...
                                <div class="col-md-4 text-right">
                                    <a href="<?= site_url() ?>/data-pelayanan/pindah_luar"
