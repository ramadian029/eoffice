...
<script type="text/javascript">
    $(document).ready(function() {
        // $('#tampil_data').load("<?php echo site_url('data_pelayanan/list_data_mati/') ?>");
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('data_pelayanan/ajax_list_mati') ?>",
                "type": "POST",
                "data": function(data) {
                    data.nik = $('#nik').val();
                    data.nama = $('#nama').val();
                        ...
                        <div id="tampil_data" class="">
                            <table id="table" class="table table-bordered table-striped table-hover" style="white-space: nowrap;">
                                <thead style="background-color: #ffffff; color:#666;">
                                    <tr>
                                        <!--Nama, jenis kelamin, tempat dan tanggal lahir, tanggal meninggal, keterangan meninggal-->
                                        <th>NO</th>
                                        <th>NAMA</th>
                                        <th>JENIS KELAMIN</th>
                                        <th>WNI/WNA</th>
