...
<script type="text/javascript">
    $(document).ready(function() {
        // $('#tampil_data').load("<?php echo site_url('data_arsip/list_data_lahir/') ?>");
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('data_arsip/ajax_list') ?>",
                "type": "POST",
                "data": function(data) {
...
<!--                    <a href="<?= site_url('unggah-data-excel-kondisi-infrastruktur/' . $aktif) ?>">
                                ...
                                <div class="panel-body">
                                    <div id='x'class="form-horizontal"> 
                                        ...
                                        <div class="form-group">
                                            <label for="country" class="col-sm-12">Perihal</label>
                                            <div class="col-sm-12">
                                                <input type="text" name="perihal" value="" class="form-control" 
                                                       id="perihal" placeholder="Perihal">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="country" class="col-sm-12">Resume</label>
                                            <div class="col-sm-12">
                                                <input type="text" name="resume" value="" class="form-control" 
                    ...
                    <div class="col-lg-6" style="text-align: right">
                        <a href="<?= site_url('data_arsip/form') ?>">
